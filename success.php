                    ...
                    <div class="mainmenu">
                        <div id="nav">
                            <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1 suc-bs-example">
...
<div class="container suc-enq">
  ...
  <div class="container wrapper">
     <div class="row">
      ...
      <form id="customerData" method="post" name="customerData" action="pay.php" class="form-horizontal">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  col-md-offset-3 col-sm-offset-3">
                    <!--SHIPPING METHOD-->
                    <div class="panel panel-success form-pay-rs">
                     
                        <div class="panel-heading">Pay Online (Optional)</div>
                      ...
                      <div class="clearfix"></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <input type="text" id="orderBillName" name="billing_name" class="form-control" value="<?php echo @$_POST['billing_name'];?>" required>
                                </div>
                                <div class="span1"></div>
                                <div class="col-md-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                   <strong>Country:</strong>
                                     <input type="text" id="orderBillCountry" name="billing_cust_country" class="form-control" value="<?php echo @$_POST['billing_cust_country'];?>" required>   
                                 </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="container">
                          <div class="footer2">
                            ...
                            <div class="footer_copyright margin-tb-50 content-center">
                                <p>Â© 2018 <a href="#">Studio CoWork</a>. All rights reserved</p> Powered by <a href="https://www.itarsia.com" target="_blank">Itarsia India </a>
                            </div>
        ...
        <div class="main main-cont">
          ...
          <div class="alert alert-danger hidden col-md-8 col-md-offset-2" role="alert">Error</div> 
                ...
                <div class="w3layouts_main_grid">
                    ...
                    <form id="regform" name="table_form" action="validation.php" method="post" class="w3_form_post">
